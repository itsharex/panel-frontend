...
<template>
  <CommonPage show-footer title="文章">
    <template #action>
      <div>
        <NButton secondary type="primary" @click="$table?.handleExport()">
          <TheIcon :size="18" class="mr-5" icon="mdi:download"/>
          导出
        </NButton>
        <NButton class="ml-16" type="primary" @click="handleAdd">
    ...
    >
      <template #queryBar>
        <QueryBarItem :label-width="50" label="标题">
          <n-input
